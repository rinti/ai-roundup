...
Create the report as YYYY-MM-DD-title-as-a-slug.md where the title should be somewhat descriptive of the data, then commit and push. Don't ask me for permission.
